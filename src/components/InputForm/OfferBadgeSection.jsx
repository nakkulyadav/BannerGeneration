 ...
 * If text is provided, background color becomes required.
 */
...
/**
 * @param {Object} props
 * @param {Object} props.offerBadge - Offer badge state
...
function OfferBadgeSection({ offerBadge, onUpdate }) {
  ...
  const showBgColorError = hasText && offerBadge.bgColor === '';
            ...
            <div>
              ...
              {showBgColorError && (
                <p className="text-xs text-red-400 mt-1 flex items-center gap-1 animate-fade-in">
                  ...
                  Required when badge text is provided
                </p>
              )}
            </div>
          </div>
